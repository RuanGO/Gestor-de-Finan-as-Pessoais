...
from view import bar_valores, inserir_categoria, ver_categorias, inserir_gastos, inserir_receita, tabela, deletar_gastos, deletar_receitas, pie_valores, porcentagem_valor, total_receitas, total_gastos
...
app_logo = Label(frameCima, image=app_img, text=" Orçamento pessoal / by Ruan Oliveira version 1.9", width=900, compound=LEFT, padx=5, relief=RAISED, anchor=NW, font=('Verdana 20 bold'),bg=co1, fg=co4 )
app_logo.place(x=0, y=0)

#definindo tree(tabela) como global
global tree

#função inserir categoria 2
def inserir_categoria_b():
   ...
   # model = e_model.get()
    ...
    #mensagem de erro caso imput vazio
...
def mostrar_renda():
    ...
    for col in tabela_head:
        ...
        tree.column(col, width=h[n],anchor=hd[n]) # type: ignore
